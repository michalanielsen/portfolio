...
?>
<section id="pfhub_portfolio_portfolio_container_<?php echo esc_attr($portfolioID); ?>" class="pfhub_portfolio_elastic_grid_content" data-object-name="<?php echo "images_obj_".esc_attr($portfolioID); ?>">
	<div id="pfhub_portfolio-container-loading-overlay_<?php echo esc_attr($portfolioID); ?>"></div>
	<div id="pfhub_portfolio_portfolio_content_<?php echo esc_attr($portfolioID); ?>"
