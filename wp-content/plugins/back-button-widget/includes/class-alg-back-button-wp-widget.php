...
class Alg_Back_Button_WP_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		$button = alg_back_button(
			$instance['button_label'],
			$instance['button_class'],
			$instance['button_style'],
			$instance['button_type'],
			$instance['button_js_func'],
			( isset( $instance['hide_on_front_page'] ) ? $instance['hide_on_front_page'] : 'no' )
		);
		$html = '';
		...
		$html .= $instance['before_button'] . $button . $instance['after_button'];
